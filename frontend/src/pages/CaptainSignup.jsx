        ...
        <div className='p-8 h-screen flex flex-col justify-between'>
            <div>
                ...
                <form onSubmit={(e) => {
                    ...
                    <input
                        className='bg-[#eeeeee] mb-2 rounded px-4 py-2 border w-full text-base placeholder:text-base'
                        required
                        value={email}
                        type="email"
                        name="email"
                ...
                <p className='text-center'>Already have an accounr? <Link to='/captain-login' className='text-blue-600'>Login here</Link></p>
            </div>
            <div>
